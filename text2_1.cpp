...
void text_festival()
{
	...
	if (king == true)
	{
		...
		if (reighnResuly == -1)
		{
			printprint("ВЫ грязный жинрый капиталист бургер все разворовали (деньги кончились)\n есть или не есть вот в чём вопрос", 15);
			printprint("\n1)съесть\n", 15);
			printprint("2)СЪЕСТЬ\n", 15);
			printprint("\nКОНЕЦ\n", 5);
		}
...
void end_microforest()
{
	...
	{
		printprint("Вы возвращаетесь домой, c пустыми руками. Это приключение было натсолько разочаровывающем что вы умираете.\n", 15);
		death();
	}
}
/*
