...
void text_festival()
{
	...
	case 2:
		...
		system("pause");
		if (krestiki() == 1) //?
			printprint("какой ВЫ молодец, выиграли гнома, который играл в первый раз. ВЫ ВЕЛИКИЙ человек! \n", 15);
		else {
			printprint("ВЫ решили поддаться гному, который видит эту игру впервые. ВЫ ВЕЛИКИЙ человек! \n", 15);
			//evil -= 3;
