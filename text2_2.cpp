...
void tunnel_2()
{
	...
	case 2:
		if (Chest)
		{
			...
			if (krestiki() == 1)
			{
				printprint("Успех! В сундуке лежало оружие, абсолютно идентичное вашему, но сильнее. +5 силы", 15);
				_player_.strength += 5;
			}
			else
	...
	case 3:
		...
		if (CornerStand)
		{
			printprint("Вы встали в угол чтобы накозать себя за все свои злые поступки. +10 добро.\n", 15);
